namespace QuickFix44
{
  ...
  {
    public OrderMassStatusRequest() : base(MsgType()) {}
    ...
    public void set(QuickFix.MassStatusReqType value)
    { setField(value); }
    public QuickFix.MassStatusReqType get(QuickFix.MassStatusReqType  value)
    { getField(value); return value; }
    public QuickFix.MassStatusReqType getMassStatusReqType()
    { QuickFix.MassStatusReqType value = new QuickFix.MassStatusReqType();
      getField(value); return value; }
    public bool isSet(QuickFix.MassStatusReqType field)
    { return isSetField(field); }
