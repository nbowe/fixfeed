namespace QuickFix44
{
  ...
  {
    public CollateralAssignment() : base(MsgType()) {}
    ...
    public void set(QuickFix.CollAsgnRefID value)
    { setField(value); }
    public QuickFix.CollAsgnRefID get(QuickFix.CollAsgnRefID  value)
    { getField(value); return value; }
    public QuickFix.CollAsgnRefID getCollAsgnRefID()
    { QuickFix.CollAsgnRefID value = new QuickFix.CollAsgnRefID();
      getField(value); return value; }
    public bool isSet(QuickFix.CollAsgnRefID field)
    { return isSetField(field); }
