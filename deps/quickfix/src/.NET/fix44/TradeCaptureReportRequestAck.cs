namespace QuickFix44
{
  ...
  {
    public TradeCaptureReportRequestAck() : base(MsgType()) {}
    ...
    public void set(QuickFix.TradeRequestResult value)
    { setField(value); }
    public QuickFix.TradeRequestResult get(QuickFix.TradeRequestResult  value)
    { getField(value); return value; }
    public QuickFix.TradeRequestResult getTradeRequestResult()
    { QuickFix.TradeRequestResult value = new QuickFix.TradeRequestResult();
      getField(value); return value; }
    public bool isSet(QuickFix.TradeRequestResult field)
    { return isSetField(field); }
    public bool isSetTradeRequestResult()
    { return isSetField(749); }

    public void set(QuickFix.TradeRequestStatus value)
    { setField(value); }
    public QuickFix.TradeRequestStatus get(QuickFix.TradeRequestStatus  value)
    { getField(value); return value; }
    public QuickFix.TradeRequestStatus getTradeRequestStatus()
    { QuickFix.TradeRequestStatus value = new QuickFix.TradeRequestStatus();
      getField(value); return value; }
    public bool isSet(QuickFix.TradeRequestStatus field)
    { return isSetField(field); }
