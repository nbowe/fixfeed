namespace QuickFix44
{
  ...
  public class MarketDataRequest : Message
  {
    ...
    public void set(QuickFix.MDImplicitDelete value)
    { setField(value); }
    public QuickFix.MDImplicitDelete get(QuickFix.MDImplicitDelete  value)
    { getField(value); return value; }
    public QuickFix.MDImplicitDelete getMDImplicitDelete()
    { QuickFix.MDImplicitDelete value = new QuickFix.MDImplicitDelete();
      getField(value); return value; }
    public bool isSet(QuickFix.MDImplicitDelete field)
    { return isSetField(field); }
