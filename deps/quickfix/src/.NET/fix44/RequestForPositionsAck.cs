namespace QuickFix44
{
  ...
  {
    public RequestForPositionsAck() : base(MsgType()) {}
    ...
    public void set(QuickFix.PosReqStatus value)
    { setField(value); }
    public QuickFix.PosReqStatus get(QuickFix.PosReqStatus  value)
    { getField(value); return value; }
    public QuickFix.PosReqStatus getPosReqStatus()
    { QuickFix.PosReqStatus value = new QuickFix.PosReqStatus();
      getField(value); return value; }
    public bool isSet(QuickFix.PosReqStatus field)
    { return isSetField(field); }
