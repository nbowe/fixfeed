namespace QuickFix44
{
  ...
  public class MarketDataIncrementalRefresh : Message
  {
    ...
    public void set(QuickFix.ApplQueueDepth value)
    { setField(value); }
    public QuickFix.ApplQueueDepth get(QuickFix.ApplQueueDepth  value)
    { getField(value); return value; }
    public QuickFix.ApplQueueDepth getApplQueueDepth()
    { QuickFix.ApplQueueDepth value = new QuickFix.ApplQueueDepth();
      getField(value); return value; }
    public bool isSet(QuickFix.ApplQueueDepth field)
    { return isSetField(field); }
    public bool isSetApplQueueDepth()
    { return isSetField(813); }

    public void set(QuickFix.ApplQueueResolution value)
    { setField(value); }
    public QuickFix.ApplQueueResolution get(QuickFix.ApplQueueResolution  value)
    { getField(value); return value; }
    public QuickFix.ApplQueueResolution getApplQueueResolution()
    { QuickFix.ApplQueueResolution value = new QuickFix.ApplQueueResolution();
      getField(value); return value; }
    public bool isSet(QuickFix.ApplQueueResolution field)
    { return isSetField(field); }
    ...
    static int[] message_order = new int[] {279,285,269,278,280,55,65,48,22,454,460,461,167,762,200,541,224,225,239,226,227,228,255,543,470,471,472,240,202,947,206,231,223,207,106,348,349,107,350,351,691,667,875,876,864,873,874,711,555,291,292,270,15,271,272,273,274,275,336,625,276,277,282,283,284,286,59,432,126,110,18,287,37,299,288,289,346,290,546,811,451,58,354,355,0};
      ...
      { setField(value); }
      public QuickFix.OpenCloseSettlFlag get(QuickFix.OpenCloseSettlFlag  value)
      { getField(value); return value; }
