namespace QuickFix44
{
  ...
  public class CollateralInquiryAck : Message
  {
    ...
    public void set(QuickFix.CollInquiryStatus value)
    { setField(value); }
    public QuickFix.CollInquiryStatus get(QuickFix.CollInquiryStatus  value)
    { getField(value); return value; }
    public QuickFix.CollInquiryStatus getCollInquiryStatus()
    { QuickFix.CollInquiryStatus value = new QuickFix.CollInquiryStatus();
      getField(value); return value; }
    public bool isSet(QuickFix.CollInquiryStatus field)
    { return isSetField(field); }
    public bool isSetCollInquiryStatus()
    { return isSetField(945); }

    public void set(QuickFix.CollInquiryResult value)
    { setField(value); }
    public QuickFix.CollInquiryResult get(QuickFix.CollInquiryResult  value)
    { getField(value); return value; }
    public QuickFix.CollInquiryResult getCollInquiryResult()
    { QuickFix.CollInquiryResult value = new QuickFix.CollInquiryResult();
      getField(value); return value; }
    public bool isSet(QuickFix.CollInquiryResult field)
    { return isSetField(field); }
