namespace QuickFix44
{
  ...
  {
    public QuoteResponse() : base(MsgType()) {}
    ...
    public void set(QuickFix.QuoteRespType value)
    { setField(value); }
    public QuickFix.QuoteRespType get(QuickFix.QuoteRespType  value)
    { getField(value); return value; }
    public QuickFix.QuoteRespType getQuoteRespType()
    { QuickFix.QuoteRespType value = new QuickFix.QuoteRespType();
      getField(value); return value; }
    public bool isSet(QuickFix.QuoteRespType field)
    { return isSetField(field); }
    ...
    static int[] message_order = new int[] {600,601,602,603,604,607,608,609,764,610,611,248,249,250,251,252,253,257,599,596,597,598,254,612,942,613,614,615,616,617,618,619,620,621,622,623,624,556,740,739,955,956,687,690,587,588,683,539,686,681,684,676,677,678,679,680,0};
