namespace QuickFix44
{
  ...
  {
    public AllocationReport() : base(MsgType()) {}
    ...
    public void set(QuickFix.AllocReportID value)
    { setField(value); }
    public QuickFix.AllocReportID get(QuickFix.AllocReportID  value)
    { getField(value); return value; }
    public QuickFix.AllocReportID getAllocReportID()
    { QuickFix.AllocReportID value = new QuickFix.AllocReportID();
      getField(value); return value; }
    public bool isSet(QuickFix.AllocReportID field)
    ...
    public void set(QuickFix.AllocReportRefID value)
    { setField(value); }
    public QuickFix.AllocReportRefID get(QuickFix.AllocReportRefID  value)
    { getField(value); return value; }
    public QuickFix.AllocReportRefID getAllocReportRefID()
    { QuickFix.AllocReportRefID value = new QuickFix.AllocReportRefID();
      getField(value); return value; }
    public bool isSet(QuickFix.AllocReportRefID field)
    { return isSetField(field); }
