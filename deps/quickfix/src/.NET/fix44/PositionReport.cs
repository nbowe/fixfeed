namespace QuickFix44
{
  ...
  public class PositionReport : Message
  {
    ...
    public void set(QuickFix.TotalNumPosReports value)
    { setField(value); }
    public QuickFix.TotalNumPosReports get(QuickFix.TotalNumPosReports  value)
    { getField(value); return value; }
    public QuickFix.TotalNumPosReports getTotalNumPosReports()
    { QuickFix.TotalNumPosReports value = new QuickFix.TotalNumPosReports();
      getField(value); return value; }
    public bool isSet(QuickFix.TotalNumPosReports field)
    { return isSetField(field); }
    ...
    public void set(QuickFix.PosReqResult value)
    { setField(value); }
    public QuickFix.PosReqResult get(QuickFix.PosReqResult  value)
    { getField(value); return value; }
    public QuickFix.PosReqResult getPosReqResult()
    { QuickFix.PosReqResult value = new QuickFix.PosReqResult();
      getField(value); return value; }
    public bool isSet(QuickFix.PosReqResult field)
    { return isSetField(field); }
    ...
    public void set(QuickFix.DeliveryDate value)
    { setField(value); }
    public QuickFix.DeliveryDate get(QuickFix.DeliveryDate  value)
    { getField(value); return value; }
    public QuickFix.DeliveryDate getDeliveryDate()
    { QuickFix.DeliveryDate value = new QuickFix.DeliveryDate();
      getField(value); return value; }
    public bool isSet(QuickFix.DeliveryDate field)
    { return isSetField(field); }
    ...
    static int[] message_order = new int[] {311,312,309,305,457,462,463,310,763,313,542,241,242,243,244,245,246,256,595,592,593,594,247,316,941,317,436,435,308,306,362,363,307,364,365,877,878,318,879,810,882,883,884,885,886,732,733,0};
      ...
      public void set(QuickFix.UnderlyingSettlPriceType value)
      { setField(value); }
      public QuickFix.UnderlyingSettlPriceType get(QuickFix.UnderlyingSettlPriceType  value)
      { getField(value); return value; }
      public QuickFix.UnderlyingSettlPriceType getUnderlyingSettlPriceType()
      { QuickFix.UnderlyingSettlPriceType value = new QuickFix.UnderlyingSettlPriceType();
        getField(value); return value; }
      public bool isSet(QuickFix.UnderlyingSettlPriceType field)
      { return isSetField(field); }
