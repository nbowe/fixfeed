namespace QuickFix44
{
  ...
  {
    public PositionMaintenanceReport() : base(MsgType()) {}
    ...
    public void set(QuickFix.PosMaintStatus value)
    { setField(value); }
    public QuickFix.PosMaintStatus get(QuickFix.PosMaintStatus  value)
    { getField(value); return value; }
    public QuickFix.PosMaintStatus getPosMaintStatus()
    { QuickFix.PosMaintStatus value = new QuickFix.PosMaintStatus();
      getField(value); return value; }
    public bool isSet(QuickFix.PosMaintStatus field)
    { return isSetField(field); }
    public bool isSetPosMaintStatus()
    { return isSetField(722); }

    public void set(QuickFix.PosMaintResult value)
    { setField(value); }
    public QuickFix.PosMaintResult get(QuickFix.PosMaintResult  value)
    { getField(value); return value; }
    public QuickFix.PosMaintResult getPosMaintResult()
    { QuickFix.PosMaintResult value = new QuickFix.PosMaintResult();
      getField(value); return value; }
    public bool isSet(QuickFix.PosMaintResult field)
    { return isSetField(field); }
