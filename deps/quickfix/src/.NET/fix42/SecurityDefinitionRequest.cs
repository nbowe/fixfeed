namespace QuickFix42
{
  ...
  {
    public SecurityDefinitionRequest() : base(MsgType()) {}
    ...
    public void set(QuickFix.SecurityRequestType value)
    { setField(value); }
    public QuickFix.SecurityRequestType get(QuickFix.SecurityRequestType  value)
    { getField(value); return value; }
    public QuickFix.SecurityRequestType getSecurityRequestType()
    { QuickFix.SecurityRequestType value = new QuickFix.SecurityRequestType();
      getField(value); return value; }
    public bool isSet(QuickFix.SecurityRequestType field)
    { return isSetField(field); }
    ...
    static int[] message_order = new int[] {311,312,309,305,310,313,314,315,316,317,436,435,308,306,362,363,307,364,365,319,54,318,0};
      ...
      public void set(QuickFix.RatioQty value)
      { setField(value); }
      public QuickFix.RatioQty get(QuickFix.RatioQty  value)
      { getField(value); return value; }
      public QuickFix.RatioQty getRatioQty()
      { QuickFix.RatioQty value = new QuickFix.RatioQty();
        getField(value); return value; }
      public bool isSet(QuickFix.RatioQty field)
      { return isSetField(field); }
