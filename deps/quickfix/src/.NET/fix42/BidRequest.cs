namespace QuickFix42
{
  ...
  public class BidRequest : Message
  {
    ...
    public void set(QuickFix.TradeType value)
    { setField(value); }
    public QuickFix.TradeType get(QuickFix.TradeType  value)
    { getField(value); return value; }
    public QuickFix.TradeType getTradeType()
    { QuickFix.TradeType value = new QuickFix.TradeType();
      getField(value); return value; }
    public bool isSet(QuickFix.TradeType field)
    { return isSetField(field); }
    ...
    static int[] message_order = new int[] {66,54,336,430,63,64,1,0};
