namespace QuickFix43
{
  ...
  public class NewOrderCross : Message
  {
    ...
    static int[] message_order = new int[] {54,11,526,583,453,229,1,581,589,590,591,78,465,38,152,516,468,469,12,13,479,497,528,529,582,121,120,58,354,355,77,203,544,635,377,659,0};
