namespace QuickFix43
{
  public class Header : QuickFix.Message.Header
  {
    Header(QuickFix.Message message) : base(message) {}
      ...
      public void set(QuickFix.OnBehalfOfSendingTime value)
      { setField(value); }
      public QuickFix.OnBehalfOfSendingTime get(QuickFix.OnBehalfOfSendingTime  value)
      { getField(value); return value; }
      public QuickFix.OnBehalfOfSendingTime getOnBehalfOfSendingTime()
      { QuickFix.OnBehalfOfSendingTime value = new QuickFix.OnBehalfOfSendingTime();
        getField(value); return value; }
      public bool isSet(QuickFix.OnBehalfOfSendingTime field)
      { return isSetField(field); }
      public bool isSetOnBehalfOfSendingTime()
  ...
  {
    public Message() : base(new QuickFix.BeginString("FIX.4.3"))
    {
      m_header = new Header(this);
      m_trailer = new Trailer(this);
    }

    public Message( QuickFix.MsgType msgType ) : base(new QuickFix.BeginString("FIX.4.3"), msgType)
    {
      m_header = new Header(this);
      m_trailer = new Trailer(this);
    }
